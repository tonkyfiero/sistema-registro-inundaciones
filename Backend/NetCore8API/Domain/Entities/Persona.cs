...
public class Persona
{
    ...
    public virtual Albergue? AlbergueActual { get; set; }

    public virtual ICollection<PersonaCondicionMedica> CondicionesMedicas { get; set; } = new List<PersonaCondicionMedica>();
}